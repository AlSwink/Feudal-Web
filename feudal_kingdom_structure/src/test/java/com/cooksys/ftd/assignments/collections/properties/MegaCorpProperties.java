...
public class MegaCorpProperties {
    ...
    @Property
    public void addNull(@Corp Kingdom corp) {
        assertFalse("#add() returned true when called with null", corp.add(null));
    }

    @Property
    public void addHasParentlessWageSlave(@Corp Kingdom corp, @Slave Peon slave) {
    ...
    @Property
    public void addHasParentlessFatCat(@Corp Kingdom corp, @Cat Lord cat) {
    ...
    @Property
    public void addHasCapitalistWithParent(@Corp Kingdom corp, @Cap(depth = 1) Feudal cap) {
    ...
    @Property
    public void addHasMultipleArbitraryCapitalists(@Corp Kingdom corp, Set<@Cap(depth = -1) Feudal> capitalists) {
        for (Feudal capitalist : capitalists) {
    ...
    @Property
    public void addHasMultipleArbitraryCapitalistNoDuplicates(@Corp Kingdom corp, Set<@Cap(depth = -1) Feudal> capitalists) {
        for (Feudal capitalist : capitalists) {
    ...
    @Property
    public void getElementsEmpty(@Corp Kingdom corp) {
        Set<Feudal> elements = corp.getElements();
    ...
    @Property
    public void getElementsDefensiveCopy(@Corp Kingdom corp, @Cap(depth = -1) Feudal capitalist) {
        Set<Feudal> elements = corp.getElements();
    ...
    @Property
    public void getElementsMultipleArbitraryCapitalists(@Corp Kingdom corp, Set<@Cap(depth = -1) Feudal> capitalists) {
        Set<Feudal> expected = new HashSet<>(capitalists);
        for (Feudal capitalist : capitalists) {
            corp.add(capitalist);
    ...
    @Property
    public void getParentsEmpty(@Corp Kingdom corp) {
        Set<Lord> parents = corp.getParents();
    ...
    @Property
    public void getParentsDefensiveCopy(@Corp Kingdom corp, @Cat Lord cat) {
        Set<Lord> parents = corp.getParents();
        parents.add(cat);
    ...
    @Property
    public void getParentsFatCat(@Corp Kingdom corp, @Cat Lord cat) {
        corp.add(cat);
        Set<Lord> parents = corp.getParents();
    ...
    @Property
    public void getParentsWageSlaveWithParent(@Corp Kingdom corp, @Slave(depth = 1) Peon slave) {
        corp.add(slave);
        Lord parent = slave.getParent();
        Set<Lord> parents = corp.getParents();
    ...
    @Property
    public void getParentsMultipleArbitraryCapitalists(@Corp Kingdom corp, Set<@Cap(depth = -1) Feudal> capitalists) {
        Set<Lord> expected = new HashSet<>();
        for (Feudal capitalist : capitalists) {
            corp.add(capitalist);
            Lord parent = capitalist instanceof Lord ? (Lord) capitalist : capitalist.getParent();
            while (parent != null) {
                expected.add(parent);
    ...
    @Property
    public void getChildrenEmpty(@Corp Kingdom corp, @Cat Lord cat) {
        Set<Feudal> children = corp.getChildren(cat);
    ...
    @Property
    public void getChildrenDefensiveCopy(@Corp Kingdom corp, @Cat Lord cat, @Cap Feudal capitalist) {
        corp.add(cat);
        Set<Feudal> children = corp.getChildren(cat);
    ...
    @Property
    public void getChildrenFatCatWithParent(@Corp Kingdom corp, @Cat(depth = 1) Lord cat) {
        corp.add(cat);
        Set<Feudal> children = corp.getChildren(cat);
    ...
    @Property
    public void getChildrenMultipleCapitalistsWithSharedParent(@Corp Kingdom corp, @Cat Lord parent, Set<@Cap Feudal> children) {
        corp.add(parent);
        Set<Feudal> expected = new HashSet<>();
        for (Feudal parentless : children) {
            Feudal withParent =
                    parentless instanceof Lord
                            ? new Lord(parentless.getName(), parentless.getSalary(), parent)
                            : new Peon(parentless.getName(), parentless.getSalary(), parent);
            corp.add(withParent);
    ...
    @Property
    public void getChildrenMultipleCapitalistsSomeWithSharedParent(@Corp Kingdom corp, @Cat Lord parent, Set<@Cap Feudal> children, Set<@Cap Feudal> loose) {
        corp.add(parent);
        Set<Feudal> expected = new HashSet<>();
        for (Feudal parentless : children) {
            Feudal withParent =
    ...
    @Property
    public void getHierarchyEmpty(@Corp Kingdom corp) {
        Map<Lord, Set<Feudal>> hierarchy = corp.getHierarchy();
    ...
    @Property
    public void getHierarchyInitializesChildSets(@Corp Kingdom corp, @Cat Lord cat) {
        corp.add(cat);
        Set<Feudal> children = corp.getHierarchy().get(cat);
    ...
    @Property
    public void getHierarchyDefensiveCopy(@Corp Kingdom corp, @Slave(depth = 1) Peon slave) {
        Set<Feudal> children = new HashSet<>();
        children.add(slave);
        Map<Lord, Set<Feudal>> hierarchy = corp.getHierarchy();
    ...
    @Property
    public void getHierarchyConsistencyWithOneLevel(@Corp(depth = 5) Kingdom corp) {
        Map<Lord, Set<Feudal>> hierarchy = corp.getHierarchy();
        Set<Lord> expectedParents = corp.getParents();
        ...
        Set<Feudal> actualElements = new HashSet<>();
        for (Lord parent : expectedParents) {
            actualElements.add(parent);
            Set<Feudal> expectedChildren = corp.getChildren(parent);
    ...
    @Property
    public void getParentChainEmpty(@Corp Kingdom corp, @Cap(depth = -1) Feudal capitalist) {
        List<Lord> actual = corp.getParentChain(null);
    ...
    @Property
    public void getParentChainMatchesInternalStructure(@Corp(depth = 5) Kingdom corp, @Cap(depth = -1) Feudal capitalist) {
        corp.add(capitalist);
        Lord parent = capitalist.getParent();
        List<Lord> expected = new LinkedList<>();
        while (parent != null) {
            expected.add(parent);
            parent = parent.getParent();
        }
